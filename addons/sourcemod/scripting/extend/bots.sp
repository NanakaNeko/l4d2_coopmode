...
public void OnPluginStart() {
	...
	g_cGiveType =				CreateConVar("bots_give_type",			"1",		"根据什么来给玩家装备. \n0=不给, 1=每个槽位的设置, 2=当前存活生还者的平均装备质量(仅主副武器).", CVAR_FLAGS);
	...
	RegConsoleCmd("sm_joingame",		cmdJoinTeam2,	"加入生还者");
	RegConsoleCmd("sm_spec",			cmdJoinTeam1,	"加入旁观者");
	RegConsoleCmd("sm_away",			cmdJoinTeam1,	"加入旁观者");
