...
public void OnPluginStart()
{
	...
	g_cvSpawnTime =			CreateConVar("l4d2_si_spawn_control_spawn_time",			"15.0",	"SI spawn time.", FCVAR_NONE, true, 1.0);
	g_cvFirstSpawnTime =	CreateConVar("l4d2_si_spawn_control_first_spawn_time",		"3.0",	"SI first spawn time (after leaving the safe area).", FCVAR_NONE, true, 0.1);
	g_cvKillSITime =		CreateConVar("l4d2_si_spawn_control_kill_si_time",			"60.0",	"Auto kill SI time. if it 'slack off'.", FCVAR_NONE, true, 0.1);
	...
	g_cvNavAreaSpawnRange =	CreateConVar("l4d2_si_spawn_control_spawn_range_navarea",	"1000", "NavArea mode spawn range, randomly spawn from 1 to this range.", FCVAR_NONE, true, 1.0);
