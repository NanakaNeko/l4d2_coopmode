...
{
  	tankpower_rock_enable = CreateConVar("l4d_tankpower_enable", "2", "  0:disable, 1:enable in coop mode, 2: enable in all mode ", FCVAR_PLUGIN);
 	 
	tankpower_rock_trace_chance = 	CreateConVar("l4d_tankpower_rock_trace_chance", "50", "the chance of trace of rock [0-100](int)");	
